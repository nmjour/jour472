...
**Answer:** This is a table describing the number of courses available per academic term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer:** This is organized by the number of courses in descending order. Meaning, the largest course listings are at the top.
...
**Answer:** This is organized by term in chronological order, and then for each term, the departments are listed alphabetically.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer:**  The table is organized by the total number of seats, in descending order.
