...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer**: The first row of data is read as the column headers.
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer**: The column headers list numbers (x1-12) instead of describing what the data is.
